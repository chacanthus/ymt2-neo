...
public class BSpline implements Path {
    ...
    public float approximate(Vector arg19, int near) {
        ...
        int v15;
        int v9 = near;
        Object v10 = this.knots.get(v9);
        Array v16 = this.knots;
        if(v9 > 0) {
            v15 = v9 - 1;
        }
        else {
        ...
        Object v12 = v16.get(v15);
        Object v11 = this.knots.get((v9 + 1) % this.spanCount);
        if(arg19.dst2(((Vector)v11)) < arg19.dst2(((Vector)v12))) {
            v4 = v10;
            v5 = v11;
            v6 = arg19;
        }
        ...
        float v1 = ((Vector)v4).dst(((Vector)v5));
        float v2 = v6.dst(((Vector)v5));
        float v3 = v6.dst(((Vector)v4));
