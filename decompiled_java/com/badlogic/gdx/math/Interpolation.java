...
public abstract class Interpolation {
    ...
    public class Elastic extends Interpolation {
        ...
        public float apply(float a) {
            ...
            if(a <= 0.5f) {
                a *= v5;
                v0 = (((float)Math.pow(((double)this.value), ((double)(this.power * (a - v4)))))) * MathUtils.sin(a * v7) * v6 / v5;
            }
            else {
                a = (v4 - a) * v5;
                v0 = v4 - (((float)Math.pow(((double)this.value), ((double)(this.power * (a - v4)))))) * MathUtils.sin(a * v7) * v6 / v5;
            }
    ...
    public class ElasticIn extends Elastic {
        ...
        public float apply(float a) {
            return (((float)Math.pow(((double)this.value), ((double)(this.power * (a - 1f)))))) * MathUtils.sin(20f * a) * 1.0955f;
        }
    }
    ...
    public class ElasticOut extends Elastic {
        ...
        public float apply(float a) {
            --a;
            return 1f - (((float)Math.pow(((double)this.value), ((double)(this.power * (a - 1f)))))) * MathUtils.sin(20f * a) * 1.0955f;
        }
    }
    ...
    static  {
        ...
        Interpolation.elastic = new Elastic(2f, 10f);
        Interpolation.elasticIn = new ElasticIn(2f, 10f);
        Interpolation.elasticOut = new ElasticOut(2f, 10f);
