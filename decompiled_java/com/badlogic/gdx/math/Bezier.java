...
public class Bezier implements Path {
    ...
    public float approximate(Vector arg11) {
        Object v3 = this.points.get(0);
        Object v4 = this.points.get(this.points.size - 1);
        float v0 = ((Vector)v3).dst(((Vector)v4));
        float v1 = arg11.dst(((Vector)v4));
        float v2 = arg11.dst(((Vector)v3));
        return MathUtils.clamp((v0 - (v1 * v1 + v0 * v0 - v2 * v2) / (2f * v0)) / v0, 0f, 1f);
    }
