...
public class AndroidDaydream extends DreamService implements Application {
    ...
    public void initialize(ApplicationListener listener, AndroidApplicationConfiguration config) {
        FillResolutionStrategy v0;
        if(config.resolutionStrategy == null) {
            v0 = new FillResolutionStrategy();
        }
        else {
            ResolutionStrategy v0_1 = config.resolutionStrategy;
        }

        this.graphics = new AndroidGraphicsDaydream(this, config, ((ResolutionStrategy)v0));
    ...
    public View initializeForView(ApplicationListener listener, AndroidApplicationConfiguration config) {
        ...
        this.graphics = new AndroidGraphicsDaydream(this, config, v0_1);
        this.input = AndroidInputFactory.newAndroidInput(((Application)this), ((Context)this), this.graphics.view, config);
        this.audio = new AndroidAudio(((Context)this), config);
        this.files = new AndroidFiles(this.getAssets(), this.getFilesDir().getAbsolutePath());
        this.net = new AndroidNet(null);
