...
public final class AndroidGraphicsDaydream implements GLSurfaceView$Renderer, Graphics {
    class AndroidDisplayMode extends DisplayMode {
        protected AndroidDisplayMode(AndroidGraphicsDaydream arg1, int width, int height, int refreshRate, int bitsPerPixel) {
            AndroidGraphicsDaydream.this = arg1;
    ...
    public AndroidGraphicsDaydream(AndroidDaydream daydream, AndroidApplicationConfiguration config, ResolutionStrategy resolutionStrategy) {
        ...
        this.config = config;
        this.view = this.createGLSurfaceView(((DreamService)daydream), config.useGL20, resolutionStrategy);
    ...
    private View createGLSurfaceView(DreamService dream, boolean useGL2, ResolutionStrategy resolutionStrategy) {
        ...
        if(!useGL2 || !this.checkGL20()) {
            ...
            com.badlogic.gdx.backends.android.AndroidGraphicsDaydream$1 v0_1 = new GLSurfaceView() {
        ...
        label_50:
            ...
            GLSurfaceViewAPI18 v0_2 = new GLSurfaceViewAPI18(((Context)dream), resolutionStrategy);
            if(v7 != null) {
            ...
            goto label_8;
        label_72:
            GLSurfaceViewCupcake v0_3 = new GLSurfaceViewCupcake(((Context)dream), resolutionStrategy);
            if(v7 != null) {
            ...
            v0 = new GLSurfaceView20(((Context)dream), resolutionStrategy);
            if(v7 != null) {
