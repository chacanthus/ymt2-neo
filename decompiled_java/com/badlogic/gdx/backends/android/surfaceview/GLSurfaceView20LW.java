...
public class GLSurfaceView20LW extends DefaultGLSurfaceViewLW {
        ...
        private void printConfig(EGL10 egl, EGLDisplay display, EGLConfig config) {
            ...
            for(v2 = 0; v2 < v1.length; ++v2) {
                ...
                if(egl.eglGetConfigAttrib(display, config, v0, v5)) {
                    String v6 = GLSurfaceView20LW.TAG;
    ...
    static  {
        GLSurfaceView20LW.TAG = "GL2JNIView";
    }

    public GLSurfaceView20LW(WallpaperService$Engine engine, ResolutionStrategy resolutionStrategy) {
        super(engine, resolutionStrategy);
        this.resolutionStrategy = resolutionStrategy;
        this.init(false, 16, 0);
    }

    public GLSurfaceView20LW(WallpaperService$Engine engine, boolean translucent, int depth, int stencil, ResolutionStrategy resolutionStrategy) {
        super(engine, resolutionStrategy);
        this.resolutionStrategy = resolutionStrategy;
    ...
    static void checkEglError(String prompt, EGL10 egl) {
        while(true) {
            ...
            String v1 = GLSurfaceView20LW.TAG;
