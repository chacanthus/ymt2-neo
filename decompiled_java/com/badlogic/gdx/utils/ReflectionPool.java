...
public class ReflectionPool extends Pool {
    ...
    public ReflectionPool(Class arg2, int initialCapacity, int max) {
        super(initialCapacity, max);
        this.constructor = this.findConstructor(arg2);
    }

    public ReflectionPool(Class arg2) {
        super();
        this.constructor = this.findConstructor(arg2);
    }
    ...
    protected Object newObject() {  // has try-catch handlers
        ...
        throw new RuntimeException("Class cannot be created (missing no-arg constructor): " + this.constructor.getDeclaringClass().getName());
        try {
        label_12:
