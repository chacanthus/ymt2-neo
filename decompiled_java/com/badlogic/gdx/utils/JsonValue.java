...
public class JsonValue implements Iterable {
    ...
    public String[] asStringArray() {
        ...
        while(v3 != null) {
            ...
            throw new IllegalStateException("Value cannot be converted to string: " + this.type);
        label_35:
            Double.toString(v3.doubleValue);
            goto label_30;
        label_38:
            Long.toString(v3.longValue);
        label_30:
            v0[v1] = v3.asString();
            v3 = v3.next;
            ++v1;
    ...
    private void prettyPrint(JsonValue object, StringBuilder buffer, int indent, PrettyPrintSettings settings) {
        ...
        label_67:
            ...
            label_77:
                ...
                label_81:
                    ...
                    this.prettyPrint(v1, buffer, indent + 1, settings);
                    if(v1.next() != null) {
                        buffer.append(",");
                    }
                    ...
                    buffer.append(v10_1);
                    if(v9 != 0 && v7 == 0 && buffer.length() - v8 > settings.singleLineColumns) {
                        buffer.setLength(v8);
                        v7 = 1;
                        goto label_77;
                    }
        ...
        label_129:
            ...
            double v2 = object.asDouble();
            long v5 = object.asLong();
            if(v2 == (((double)v5))) {
                v2 = ((double)v5);
            }
        ...
        label_148:
            ...
            label_11:
                ...
                label_16:
                    ...
                    buffer.append(settings.outputType.quoteName(v1.name()));
                    buffer.append(": ");
                    this.prettyPrint(v1, buffer, indent + 1, settings);
                    if(v1.next() != null) {
                        buffer.append(",");
                    ...
                    buffer.append(v10_1);
                    if(v7 == 0 && buffer.length() - v8 > settings.singleLineColumns) {
                        buffer.setLength(v8);
                        v7 = 1;
                        goto label_11;
                    }
    ...
    public String toString() {
        String v0;
        if(!this.isValue()) {
            v0 = this.prettyPrint(OutputType.minimal, 0);
        }
