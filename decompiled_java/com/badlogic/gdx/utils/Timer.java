...
public class Timer {
    ...
    public void postTask(Task task) {
        this.scheduleTask(task, 0f, 0f, 0);
    }
    ...
    public void scheduleTask(Task task, float delaySeconds) {
        this.scheduleTask(task, delaySeconds, 0f, 0);
    }
    ...
    public void scheduleTask(Task task, float delaySeconds, float intervalSeconds, int repeatCount) {  // has try-catch handlers
        float v4 = 1000f;
