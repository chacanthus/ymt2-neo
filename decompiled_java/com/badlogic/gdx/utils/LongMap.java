...
public class LongMap {
    ...
    public Object get(long key, Object arg6) {
        if(key != 0) {
            int v0 = ((int)((((long)this.mask)) & key));
            if(this.keyTable[v0] != key) {
                v0 = this.hash2(key);
    ...
    private Object getStash(long key, Object arg8) {
        long[] v1 = this.keyTable;
        int v0 = this.capacity;
        int v2 = v0 + this.stashSize;
        while(v0 < v2) {
    ...
    private void push(long insertKey, Object arg13, int index1, long key1, int index2, long key2, int index3, long key3) {
        int v8;
        Object v2;
        long v0;
    ...
    public Object put(long key, Object arg22) {
        ...
        if(key == 0) {
            ...
            int v6 = ((int)((((long)this.mask)) & key));
            long v7 = v16[v6];
            if(v7 == key) {
                v18 = this.valueTable[v6];
                this.valueTable[v6] = arg22;
            }
            else {
                int v9 = this.hash2(key);
                long v10 = v16[v9];
                if(v10 == key) {
                    v18 = this.valueTable[v9];
                    this.valueTable[v9] = arg22;
                }
                else {
                    int v12 = this.hash3(key);
                    long v13 = v16[v12];
                    if(v13 == key) {
                        v18 = this.valueTable[v12];
                        this.valueTable[v12] = arg22;
                    }
                    else {
                        int v15 = this.capacity;
                        int v17 = v15 + this.stashSize;
                        while(true) {
                            if(v15 >= v17) {
                                break;
                            }
                            else if(v16[v15] == key) {
                                v18 = this.valueTable[v15];
                                this.valueTable[v15] = arg22;
                            }
                            else {
                                ++v15;
                                continue;
                        ...
                        label_117:
                            ...
                            goto label_19;
                        label_138:
                            this.push(key, arg22, v6, v7, v9, v10, v12, v13);
                            v18 = null;
                        }
                    }
                }
    ...
    private void putResize(long key, Object arg17) {
        int v1;
        if(key == 0) {
            this.zeroValue = arg17;
            this.hasZeroValue = true;
        }
        else {
            int v5 = ((int)((((long)this.mask)) & key));
            long v6 = this.keyTable[v5];
            if(v6 == 0) {
                this.keyTable[v5] = key;
                this.valueTable[v5] = arg17;
                v1 = this.size;
                this.size = v1 + 1;
                ...
                int v8 = this.hash2(key);
                long v9 = this.keyTable[v8];
                if(v9 == 0) {
                    this.keyTable[v8] = key;
                    this.valueTable[v8] = arg17;
                    v1 = this.size;
                    this.size = v1 + 1;
                    if(v1 >= this.threshold) {
                        this.resize(this.capacity << 1);
                    ...
                    int v11 = this.hash3(key);
                    long v12 = this.keyTable[v11];
                    if(v12 == 0) {
                        this.keyTable[v11] = key;
                        this.valueTable[v11] = arg17;
                        v1 = this.size;
                        this.size = v1 + 1;
                        if(v1 >= this.threshold) {
                            this.resize(this.capacity << 1);
                        ...
                        this.push(key, arg17, v5, v6, v8, v9, v11, v12);
                    }
                }
            }
        }
    ...
    private void resize(int newSize) {
        int v7;
        int v3 = this.capacity + this.stashSize;
