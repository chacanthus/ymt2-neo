        ...
        if(!this._finished) {
            ...
            if(this.nowPos64 == 0) {
                if(this._matchFinder.GetNumAvailableBytes() == 0) {
                    ...
                    v5 = this._matchFinder.GetIndexByte(-this._additionalOffset);
                    this._literalEncoder.GetSubCoder(((int)this.nowPos64), this._previousByte).Encode(this._rangeEncoder, v5);
                    this._previousByte = v5;
            ...
            do {
            label_154:
                int v9 = this.GetOptimum(((int)this.nowPos64));
                int v12 = this.backRes;
                int v15 = (((int)this.nowPos64)) & this._posStateMask;
                int v4 = (this._state << 4) + v15;
                if(v9 != 1 || v12 != -1) {
                    ...
                    if(v12 < 4) {
                        ...
                        if(v12 == 0) {
                            ...
                            if(v12 == 1) {
                                ...
                                this._rangeEncoder.Encode(this._isRepG2, this._state, v12 - 2);
                            }
                        }
                        ...
                        if(v9 == 1) {
                            ...
                            this._repMatchLenEncoder.Encode(this._rangeEncoder, v9 - 2, v15);
                            this._state = Base.StateUpdateRep(this._state);
                        }

                        v6 = this._repDistances[v12];
                        if(v12 == 0) {
                            goto label_488;
                        }
                        ...
                        int v8;
                        for(v8 = v12; v8 >= 1; --v8) {
                            this._repDistances[v8] = this._repDistances[v8 - 1];
                        }
                        ...
                        this._lenEncoder.Encode(this._rangeEncoder, v9 - 2, v15);
                        v12 += -4;
                        int v14 = Encoder.GetPosSlot(v12);
                        this._posSlotEncoder[Base.GetLenToPosState(v9)].Encode(this._rangeEncoder, v14);
                        if(v14 >= 4) {
                            int v7 = (v14 >> 1) - 1;
                            int v3 = (v14 & 1 | 2) << v7;
                            int v13 = v12 - v3;
                            if(v14 < 14) {
                                BitTreeEncoder.ReverseEncode(this._posEncoders, v3 - v14 - 1, this._rangeEncoder, v7, v13);
                            }
                            else {
                                this._rangeEncoder.EncodeDirectBits(v13 >> 4, v7 - 4);
                                this._posAlignEncoder.ReverseEncode(this._rangeEncoder, v13 & 15);
                ...
                label_488:
                    this._previousByte = this._matchFinder.GetIndexByte(v9 - 1 - this._additionalOffset);
                }
                else {
                    this._rangeEncoder.Encode(this._isMatch, v4, 0);
                    v5 = this._matchFinder.GetIndexByte(-this._additionalOffset);
                    Encoder2 v18 = this._literalEncoder.GetSubCoder(((int)this.nowPos64), this._previousByte);
                    if(!Base.StateIsCharState(this._state)) {
                        v18.EncodeMatched(this._rangeEncoder, this._matchFinder.GetIndexByte(-this._repDistances[0] - 1 - this._additionalOffset), v5);
                    }
                    else {
                        v18.Encode(this._rangeEncoder, v5);
                    }
                ...
                this._additionalOffset -= v9;
                this.nowPos64 += ((long)v9);
