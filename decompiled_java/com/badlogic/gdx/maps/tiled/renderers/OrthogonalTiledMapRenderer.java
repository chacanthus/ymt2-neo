...
public class OrthogonalTiledMapRenderer extends BatchTiledMapRenderer {
    ...
    public void renderTileLayer(TiledMapTileLayer layer) {
        float v22;
        Color v5 = this.spriteBatch.getColor();
        ...
        float v35 = (((float)v20)) * v14;
        float v34 = (((float)v8)) * v15;
        float[] v30 = this.vertices;
        int v19;
        for(v19 = v20; v19 < v21; ++v19) {
            float v31 = v34;
            int v7;
            for(v7 = v8; v7 < v9; ++v7) {
                ...
                if(v6 == null) {
                    ...
                    if(v25 != null) {
                        ...
                        float v33 = v31 + (((float)v17.getRegionWidth())) * this.unitScale;
                        float v37 = v35 + (((float)v17.getRegionHeight())) * this.unitScale;
                        float v26 = v17.getU();
                        float v28 = v17.getV2();
                        float v27 = v17.getU2();
                        float v29 = v17.getV();
                    ...
                    label_222:
                        this.spriteBatch.draw(v17.getTexture(), v30, 0, 20);
                    }
