            ...
            for(v7 = v8; v7 < v9; ++v7) {
                ...
                if(v6 == null) {
                    ...
                    if(v29 != null && !(v29 instanceof AnimatedTiledMapTile)) {
                        ...
                        float v37 = v35 + (((float)v21.getRegionWidth())) * this.unitScale;
                        float v40 = v38 + (((float)v21.getRegionHeight())) * this.unitScale;
                        float v30 = v21.getU();
                        float v32 = v21.getV2();
                        float v31 = v21.getU2();
                        float v33 = v21.getV();
                        ...
                        break;
                    label_285:
                        this.spriteBatch.draw(v21.getTexture(), v34, 0, 20);
                    }
                }
            }
        }
