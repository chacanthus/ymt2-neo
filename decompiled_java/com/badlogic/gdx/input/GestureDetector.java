...
public class GestureDetector extends InputAdapter {
    ...
    public boolean touchUp(float x, float y, int pointer, int button) {
        ...
        if(pointer <= 1) {
            ...
            this.gestureStartTime = v9;
            v4 = this.listener.tap(x, y, this.tapCount, button);
            goto label_4;
        label_48:
            if(!this.pinching) {
                goto label_71;
        ...
        label_71:
            ...
            if(v1 - this.tracker.lastTime < this.maxFlingDelay) {
                this.tracker.update(x, y, v1);
