...
public class Body {
    ...
    public Fixture createFixture(FixtureDef def) {
        long v14 = this.jniCreateFixture(this.addr, def.shape.addr, def.friction, def.restitution, def.density, def.isSensor, def.filter.categoryBits, def.filter.maskBits, def.filter.groupIndex);
        Object v13 = this.world.freeFixtures.obtain();
        ((Fixture)v13).reset(this, v14);
        this.world.fixtures.put(((Fixture)v13).addr, v13);
        this.fixtures.add(v13);
        return ((Fixture)v13);
    }

    public Fixture createFixture(Shape shape, float density) {
        long v7 = this.jniCreateFixture(this.addr, shape.addr, density);
        Object v6 = this.world.freeFixtures.obtain();
        ((Fixture)v6).reset(this, v7);
        this.world.fixtures.put(((Fixture)v6).addr, v6);
        this.fixtures.add(v6);
        return ((Fixture)v6);
    }
    ...
    private native void jniDestroyFixture(long arg1) {
    }
