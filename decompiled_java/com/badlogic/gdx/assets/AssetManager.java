...
public class AssetManager implements Disposable {
    ...
    private void disposeDependencies(String fileName) {
        Object v1 = this.assetDependencies.get(fileName);
        if(v1 != null) {
            Iterator v3 = ((Array)v1).iterator();
            while(v3.hasNext()) {
                this.disposeDependencies(v3.next());
            }
        }

        Object v0 = this.assets.get(this.assetTypes.get(fileName)).get(fileName).getObject(Object.class);
        if((v0 instanceof Disposable)) {
            ((Disposable)v0).dispose();
        }
    }
    ...
    void injectDependencies(String parentAssetFilename, Array arg5) {  // has try-catch handlers
        try {
            Iterator v1 = arg5.iterator();
            while(v1.hasNext()) {
                this.injectDependency(parentAssetFilename, v1.next());
            }
        }
        catch(Throwable v2) {
            goto label_7;
    ...
    private void injectDependency(String parentAssetFilename, AssetDescriptor dependendAssetDesc) {  // has try-catch handlers
        try {
            ...
            if(v1 == null) {
                Array v1_1 = new Array();
                this.assetDependencies.put(parentAssetFilename, v1_1);
            }

            ((Array)v1).add(dependendAssetDesc.fileName);
    ...
    public boolean update(int millis) {
        boolean v0;
        long v1 = System.currentTimeMillis() + (((long)millis));
        while(true) {
            v0 = this.update();
            if(!v0 && System.currentTimeMillis() <= v1) {
                ThreadUtils.yield();
                continue;
            }
    ...
    private boolean updateTask() {
        ...
        if(((AssetLoadingTask)v2).update()) {
            ...
            this.unload(((AssetLoadingTask)v2).assetDesc.fileName);
            goto label_24;
        label_25:
