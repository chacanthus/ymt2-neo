...
public class Attributes implements Iterable, Comparator {
    ...
    public final Attribute get(Class arg2, long type) {
        return this.get(type);
    }

    public final Array get(Array arg6, long type) {
        int v0;
        for(v0 = 0; v0 < this.attributes.size; ++v0) {
            if((this.attributes.get(v0).type & type) != 0) {
                arg6.add(this.attributes.get(v0));
            }
        }
    ...
    public final void remove(long mask) {
        int v0;
        for(v0 = 0; v0 < this.attributes.size; ++v0) {
            long v1 = this.attributes.get(v0).type;
            if((mask & v1) == v1) {
