...
public class ModelInstance implements RenderableProvider {
    ...
    public ModelInstance(Model model, Matrix4 transform, String nodeId, boolean recursive, boolean parentTransform, boolean mergeTransform) {
        ...
        if(mergeTransform) {
            ...
            this.transform.mul(v1.parent.globalTransform);
        }
    ...
    private void copyAnimations(Iterable arg13) {
        Iterator v4;
        NodeAnimation v9;
        Node v8;
        Object v7;
        ...
        while(true) {
            ...
            v9.node = v8;
            v4 = ((NodeAnimation)v7).keyframes.iterator();
            break;
        label_46:
        ...
        while(true) {
            ...
            v5.keytime = ((NodeKeyframe)v6).keytime;
            v5.rotation.set(((NodeKeyframe)v6).rotation);
            v5.scale.set(((NodeKeyframe)v6).scale);
            v5.translation.set(((NodeKeyframe)v6).translation);
            v9.keyframes.add(v5);
        }
    ...
    private Node copyNode(Node parent, Node node) {
        ...
        v2 = node.children.iterator();
        while(v2.hasNext()) {
            v1.children.add(this.copyNode(v1, v2.next()));
        }
    ...
    private void copyNodes(Array arg8, Array arg9) {
        ...
        while(v0 < v2) {
            ...
            this.nodes.add(this.copyNode(null, ((Node)v3)));
        label_17:
            ++v0;
        }
    ...
    private void copyNodes(Array arg6) {
        ...
        int v1 = arg6.size;
        while(v0 < v1) {
            this.nodes.add(this.copyNode(null, arg6.get(v0)));
            ++v0;
        }
        ...
        while(v1 < v4) {
            ...
            while(v2 < v3) {
                if(v0[v2].equals(((Node)v5).id)) {
                    this.nodes.add(this.copyNode(null, ((Node)v5)));
                }
                else {
                    ++v2;
                    continue;
    ...
    protected void getRenderables(Node node, Array arg6, Pool arg7) {
        ...
        if(node.parts.size > 0) {
            ...
            while(v1.hasNext()) {
                arg6.add(this.getRenderable(arg7.obtain(), node, v1.next()));
            }
        }
