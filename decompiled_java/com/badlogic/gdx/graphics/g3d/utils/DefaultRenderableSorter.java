...
public class DefaultRenderableSorter implements RenderableSorter, Comparator {
    ...
    public int compare(Renderable o1, Renderable o2) {
        ...
        if(o1.material.has(BlendingAttribute.Type)) {
            v0 = o1.material.get(BlendingAttribute.Type).blended;
        }
        else {
            v0 = false;
        }
        ...
        if(o2.material.has(BlendingAttribute.Type)) {
            v1 = o2.material.get(BlendingAttribute.Type).blended;
        }
        else {
            v1 = false;
        }
        ...
        if(v0 == v1) {
            ...
            float v2 = this.camera.position.dst2(this.tmpV1) - this.camera.position.dst2(this.tmpV2);
            if(v2 < 0f) {
                v3 = v7;
            }
            else if(v2 > 0f) {
