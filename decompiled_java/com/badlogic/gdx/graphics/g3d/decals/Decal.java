...
public class Decal {
    ...
    static  {
        ...
        Decal.X_AXIS = new Vector3(1f, 0f, 0f);
        Decal.Y_AXIS = new Vector3(0f, 1f, 0f);
        Decal.Z_AXIS = new Vector3(0f, 0f, 1f);
    }
    ...
    public void rotateX(float angle) {
        Decal.rotator.set(Decal.X_AXIS, angle);
        this.rotation.mul(Decal.rotator);
        this.updated = false;
    }

    public void rotateY(float angle) {
        Decal.rotator.set(Decal.Y_AXIS, angle);
        this.rotation.mul(Decal.rotator);
        this.updated = false;
    }

    public void rotateZ(float angle) {
        Decal.rotator.set(Decal.Z_AXIS, angle);
        this.rotation.mul(Decal.rotator);
        this.updated = false;
    }
    ...
    public void setRotationX(float angle) {
        this.rotation.set(Decal.X_AXIS, angle);
        this.updated = false;
    }

    public void setRotationY(float angle) {
        this.rotation.set(Decal.Y_AXIS, angle);
        this.updated = false;
    }

    public void setRotationZ(float angle) {
        this.rotation.set(Decal.Z_AXIS, angle);
        this.updated = false;
    }
