...
public class ShaderProgram implements Disposable {
    ...
    public void setAttributef(String name, float value1, float value2, float value3, float value4) {
        Gdx.graphics.getGL20().glVertexAttrib4f(this.fetchAttributeLocation(name), value1, value2, value3, value4);
    }
    ...
    public void setUniform1fv(int location, float[] values, int offset, int length) {
        ...
        v0.glUniform1fv(location, length, this.floatBuffer);
    }

    public void setUniform1fv(String name, float[] values, int offset, int length) {
        GL20 v0 = Gdx.graphics.getGL20();
        this.checkManaged();
        int v1 = this.fetchUniformLocation(name);
        this.ensureBufferCapacity(length << 2);
        this.floatBuffer.clear();
        BufferUtils.copy(values, this.floatBuffer, length, offset);
        v0.glUniform1fv(v1, length, this.floatBuffer);
    }
    ...
    public void setUniform2fv(int location, float[] values, int offset, int length) {
        ...
        this.floatBuffer.clear();
        BufferUtils.copy(values, this.floatBuffer, length, offset);
        v0.glUniform2fv(location, length / 2, this.floatBuffer);
    }
    ...
    public void setUniform2fv(String name, float[] values, int offset, int length) {
        ...
        this.floatBuffer.clear();
        BufferUtils.copy(values, this.floatBuffer, length, offset);
        v0.glUniform2fv(v1, length / 2, this.floatBuffer);
    }
    ...
    public void setUniform3fv(int location, float[] values, int offset, int length) {
        ...
        this.floatBuffer.clear();
        BufferUtils.copy(values, this.floatBuffer, length, offset);
        v0.glUniform3fv(location, length / 3, this.floatBuffer);
    }
    ...
    public void setUniform3fv(String name, float[] values, int offset, int length) {
        ...
        this.floatBuffer.clear();
        BufferUtils.copy(values, this.floatBuffer, length, offset);
        v0.glUniform3fv(v1, length / 3, this.floatBuffer);
    }
    ...
    public void setUniform4fv(int location, float[] values, int offset, int length) {
        ...
        this.floatBuffer.clear();
        BufferUtils.copy(values, this.floatBuffer, length, offset);
        v0.glUniform4fv(location, length / 4, this.floatBuffer);
    }
    ...
    public void setUniform4fv(String name, float[] values, int offset, int length) {
        ...
        this.floatBuffer.clear();
        BufferUtils.copy(values, this.floatBuffer, length, offset);
        v0.glUniform4fv(v1, length / 4, this.floatBuffer);
    }
    ...
    public void setUniformMatrix(int location, Matrix3 matrix, boolean transpose) {
        GL20 v0 = Gdx.graphics.getGL20();
        this.checkManaged();
        float[] v1 = matrix.getValues();
        this.matrix.clear();
        BufferUtils.copy(v1, this.matrix, v1.length, 0);
        v0.glUniformMatrix3fv(location, 1, transpose, this.matrix);
    }
    ...
    public void setUniformMatrix(int location, Matrix4 matrix, boolean transpose) {
        ...
        v0.glUniformMatrix4fv(location, 1, transpose, this.matrix);
    }
    ...
    public void setUniformMatrix(String name, Matrix3 matrix, boolean transpose) {
        ...
        this.matrix.clear();
        BufferUtils.copy(v2, this.matrix, v2.length, 0);
        v0.glUniformMatrix3fv(v1, 1, transpose, this.matrix);
    }
    ...
    public void setUniformMatrix(String name, Matrix4 matrix, boolean transpose) {
        ...
        this.matrix.clear();
        BufferUtils.copy(matrix.val, this.matrix, matrix.val.length, 0);
        v0.glUniformMatrix4fv(v1, 1, transpose, this.matrix);
    }
    ...
    public void setUniformMatrix4fv(int location, float[] values, int offset, int length) {
        ...
        this.floatBuffer.clear();
        BufferUtils.copy(values, this.floatBuffer, length, offset);
        v0.glUniformMatrix4fv(location, length / 16, false, this.floatBuffer);
    }
    ...
    public void setUniformMatrix4fv(String name, float[] values, int offset, int length) {
        ...
        this.floatBuffer.clear();
        BufferUtils.copy(values, this.floatBuffer, length, offset);
        v0.glUniformMatrix4fv(this.fetchUniformLocation(name), length / 16, false, this.floatBuffer);
    }
