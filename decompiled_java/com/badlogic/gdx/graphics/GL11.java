...
public abstract interface GL11 extends GL10 {
    ...
    public abstract void glClipPlanef(int arg0, FloatBuffer arg1);

    public abstract void glClipPlanef(int arg0, float[] arg1, int arg2);

    public abstract void glColor4ub(byte arg0, byte arg1, byte arg2, byte arg3);

    public abstract void glColorPointer(int arg0, int arg1, int arg2, int arg3);
    ...
    public abstract void glGetBooleanv(int arg0, IntBuffer arg1);

    public abstract void glGetBooleanv(int arg0, boolean[] arg1, int arg2);
    ...
    public abstract void glGetClipPlanef(int arg0, FloatBuffer arg1);

    public abstract void glGetClipPlanef(int arg0, float[] arg1, int arg2);

    public abstract void glGetFloatv(int arg0, FloatBuffer arg1);

    public abstract void glGetFloatv(int arg0, float[] arg1, int arg2);

    public abstract void glGetLightfv(int arg0, int arg1, FloatBuffer arg2);

    public abstract void glGetLightfv(int arg0, int arg1, float[] arg2, int arg3);

    public abstract void glGetMaterialfv(int arg0, int arg1, FloatBuffer arg2);

    public abstract void glGetMaterialfv(int arg0, int arg1, float[] arg2, int arg3);

    public abstract void glGetPointerv(int arg0, Buffer[] arg1);

    public abstract void glGetTexEnviv(int arg0, int arg1, IntBuffer arg2);

    public abstract void glGetTexEnviv(int arg0, int arg1, int[] arg2, int arg3);
    ...
    public abstract void glNormalPointer(int arg0, int arg1, int arg2);

    public abstract void glPointParameterf(int arg0, float arg1);

    public abstract void glPointParameterfv(int arg0, FloatBuffer arg1);

    public abstract void glPointParameterfv(int arg0, float[] arg1, int arg2);

    public abstract void glPointSizePointerOES(int arg0, int arg1, Buffer arg2);

    public abstract void glTexCoordPointer(int arg0, int arg1, int arg2, int arg3);

    public abstract void glTexEnvi(int arg0, int arg1, int arg2);

    public abstract void glTexEnviv(int arg0, int arg1, IntBuffer arg2);

    public abstract void glTexEnviv(int arg0, int arg1, int[] arg2, int arg3);
    ...
    public abstract void glVertexPointer(int arg0, int arg1, int arg2, int arg3);
}
