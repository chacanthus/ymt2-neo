...
public abstract interface TextureData {
    public enum TextureDataType {
        public static final enum TextureDataType Compressed;
        public static final enum TextureDataType Float;
        public static final enum TextureDataType Pixmap;

        static  {
            TextureDataType.Pixmap = new TextureDataType("Pixmap", 0);
            TextureDataType.Compressed = new TextureDataType("Compressed", 1);
            TextureDataType.Float = new TextureDataType("Float", 2);
            TextureDataType[] v0 = new TextureDataType[3];
            v0[0] = TextureDataType.Pixmap;
            v0[1] = TextureDataType.Compressed;
            v0[2] = TextureDataType.Float;
    ...
    public abstract void consumeCompressedData(int arg0);
