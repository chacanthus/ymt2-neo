...
public class SpriteCache implements Disposable {
    ...
    public void begin() {
        ...
        if(!Gdx.graphics.isGL20Available()) {
            GL10 v0 = Gdx.gl10;
            v0.glDepthMask(false);
            v0.glEnable(3553);
            v0.glMatrixMode(5889);
            v0.glLoadMatrixf(this.projectionMatrix.val, 0);
            v0.glMatrixMode(5888);
            v0.glLoadMatrixf(this.transformMatrix.val, 0);
            this.mesh.bind();
        }
        else {
    ...
    public void draw(int cacheID) {
        ...
        int v5 = ((Cache)v0).offset / (v7 * 5) * 6;
        Texture[] v6 = ((Cache)v0).textures;
        int[] v2 = ((Cache)v0).counts;
        if(Gdx.graphics.isGL20Available()) {
            v3 = 0;
            v4 = ((Cache)v0).textureCount;
            while(v3 < v4) {
                v1 = v2[v3];
                v6[v3].bind();
                if(this.customShader != null) {
                    this.mesh.render(this.customShader, v8, v5, v1);
                }
                else {
                    this.mesh.render(this.shader, v8, v5, v1);
                }
