...
public class PolygonSpriteBatch implements Batch {
    ...
    public void dispose() {
        int v0;
        for(v0 = 0; v0 < this.buffers.length; ++v0) {
            this.buffers[v0].dispose();
        }
