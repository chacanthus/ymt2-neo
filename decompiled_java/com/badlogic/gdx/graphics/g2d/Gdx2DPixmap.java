...
public class Gdx2DPixmap implements Disposable {
    ...
    public Gdx2DPixmap(byte[] encodedData, int offset, int len, int requestedFormat) throws IOException {
        super();
        this.nativeData = new long[4];
        this.pixelPtr = Gdx2DPixmap.load(this.nativeData, encodedData, offset, len, requestedFormat);
        if(this.pixelPtr == null) {
            throw new IOException("couldn\'t load pixmap " + Gdx2DPixmap.getFailureReason());
        }
    ...
    public Gdx2DPixmap(InputStream in, int requestedFormat) throws IOException {
        ...
        v0 = v1.toByteArray();
        this.pixelPtr = Gdx2DPixmap.load(this.nativeData, v0, 0, v0.length, requestedFormat);
        if(this.pixelPtr == null) {
            throw new IOException("couldn\'t load pixmap " + Gdx2DPixmap.getFailureReason());
        }
    ...
    private static native ByteBuffer load(long[] arg0, byte[] arg1, int arg2, int arg3, int arg4) {
    }
