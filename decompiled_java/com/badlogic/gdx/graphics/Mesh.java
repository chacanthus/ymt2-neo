...
public class Mesh implements Disposable {
    public enum VertexDataType {
        ...
        static  {
            ...
            VertexDataType[] v0 = new VertexDataType[3];
    ...
    public static Mesh create(boolean isStatic, Mesh base, Matrix4[] transformations) {
        VertexAttribute v13 = base.getVertexAttribute(1);
        int v4 = v13.offset / 4;
        int v5 = v13.numComponents;
        int v7 = base.getNumVertices();
        int v3 = base.getVertexSize() / 4;
        int v8 = v7 * v3;
        int v12 = base.getNumIndices();
        float[] v2 = new float[v7 * v3 * transformations.length];
        short[] v10 = new short[transformations.length * v12];
        base.getIndices(v10);
        int v9;
        for(v9 = 0; v9 < transformations.length; ++v9) {
            base.getVertices(0, v8, v2, v8 * v9);
            Mesh.transform(transformations[v9], v2, v3, v4, v5, v7 * v9, v7);
            if(v9 > 0) {
                int v11;
                for(v11 = 0; v11 < v12; ++v11) {
                    v10[v12 * v9 + v11] = ((short)(v10[v11] + v7 * v9));
                }
            }
        }

        Mesh v14 = new Mesh(isStatic, v2.length / v3, v10.length, base.getVertexAttributes());
        v14.setVertices(v2);
        v14.setIndices(v10);
        return v14;
    }
    ...
    public static Mesh create(boolean isStatic, Mesh[] meshes, Matrix4[] transformations) {
        ...
        VertexAttributes v10 = meshes[0].getVertexAttributes();
        int v20 = meshes[0].getNumVertices();
        int v12 = meshes[0].getNumIndices();
        int v11;
        for(v11 = 1; v11 < meshes.length; ++v11) {
            if(!meshes[v11].getVertexAttributes().equals(v10)) {
                throw new IllegalArgumentException("Inconsistent VertexAttributes");
            }

            v20 += meshes[v11].getNumVertices();
            v12 += meshes[v11].getNumIndices();
        }

        VertexAttribute v18 = meshes[0].getVertexAttribute(1);
        int v6 = v18.offset / 4;
        int v7 = v18.numComponents;
        int v5 = v10.vertexSize / 4;
        float[] v4 = new float[v20 * v5];
        short[] v13 = new short[v12];
        meshes[0].getVertices(v4);
        meshes[0].getIndices(v13);
        int v21 = meshes[0].getNumVertices() * v5;
        int v14 = meshes[0].getNumIndices();
        for(v11 = 1; v11 < meshes.length; ++v11) {
            Mesh v17 = meshes[v11];
            int v22 = v17.getNumVertices() * v5;
            int v15 = v17.getNumIndices();
            v17.getVertices(0, v22, v4, v21);
            if(transformations != null) {
                Mesh.transform(transformations[v11], v4, v5, v6, v7, v21 / v5, v22 / v5);
            }

            v17.getIndices(v13, v14);
            int v16 = 0;
            while(v16 < v15) {
                v13[v14 + v16] = ((short)(v13[v14 + v16] + v21));
                ++v16;
            }
        ...
        Mesh v19 = new Mesh(isStatic, v4.length / v5, v13.length, v10);
        v19.setVertices(v4);
        v19.setIndices(v13);
        return v19;
    }
    ...
    public static void invalidateAllMeshes(Application app) {
        ...
        if(v1 != null) {
            ...
            for(v0 = 0; v0 < ((Array)v1).size; ++v0) {
                if((((Array)v1).get(v0).vertices instanceof VertexBufferObject)) {
    ...
    public void render(int primitiveType) {
        ...
        if(this.indices.getNumMaxIndices() > 0) {
            v0 = this.getNumIndices();
        }
        else {
            v0 = this.getNumVertices();
        }

        this.render(primitiveType, 0, v0, this.autoBind);
    }
        ...
        if(count != 0) {
            ...
            if(this.isVertexArray) {
                if(this.indices.getNumIndices() > 0) {
                    ...
                    Gdx.gl10.glDrawElements(primitiveType, count, v5, ((Buffer)v0));
                    v0.position(v2);
                    v0.limit(v1);
                }
                else {
                ...
                Gdx.gl11.glDrawElements(primitiveType, count, v5, offset * 2);
            }
            else {
    ...
    public void render(int primitiveType, int offset, int count) {
        this.render(primitiveType, offset, count, this.autoBind);
    }
