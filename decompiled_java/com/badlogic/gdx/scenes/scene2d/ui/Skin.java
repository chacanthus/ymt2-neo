...
public class Skin implements Disposable {
    ...
    public String find(Object resource) {
        ...
        if(v0 == null) {
            ...
            Object v1_1 = ((ObjectMap)v0).findKey(resource, true);
        }
        ...
        label_10:
            ...
            if((v6 instanceof AtlasRegion)) {
                ...
                if(((AtlasRegion)v4).splits != null) {
                    ...
                    SpriteDrawable v2_2 = new SpriteDrawable(this.getSprite(name));
                }
            }
            else {
                goto label_60;
    ...
    label_21:
        if(v1 == null) {
            ...
            if(v3 != null) {
                ...
                if(v5 != null) {
                    SpriteDrawable v1_3 = new SpriteDrawable(((Sprite)v5));
                }
                else {
        ...
        this.add(name, v1, Drawable.class);
        v2 = v1;
    label_4:
        return ((Drawable)v2);
    }
    ...
    protected Json getJsonLoader(FileHandle skinFile) {
        ...
        ((Json)v0).setSerializer(BitmapFont.class, new ReadOnlySerializer() {
            public BitmapFont read(Json json, JsonValue jsonData, Class type) {  // has try-catch handlers
                BitmapFont v2;
                Object v5 = json.readValue("file", String.class, jsonData);
                int v8 = json.readValue("scaledSize", Integer.TYPE, Integer.valueOf(-1), jsonData).intValue();
                Object v1 = json.readValue("flip", Boolean.class, Boolean.valueOf(false), jsonData);
                FileHandle v3 = this.val$skinFile.parent().child(((String)v5));
                if(!v3.exists()) {
                    v3 = Gdx.files.internal(((String)v5));
                }
                ...
                String v7 = v3.nameWithoutExtension();
                try {
                    Object v6 = this.val$skin.optional(v7, TextureRegion.class);
                    if(v6 != null) {
                        v2 = new BitmapFont(v3, ((TextureRegion)v6), ((Boolean)v1).booleanValue());
                    }
                    else {
                        FileHandle v4 = v3.parent().child(v7 + ".png");
                        if(v4.exists()) {
                    ...
                    if(v8 != -1) {
                        v2.setScale((((float)v8)) / v2.getCapHeight());
                    }
        ...
        ((Json)v0).setSerializer(TintedDrawable.class, new ReadOnlySerializer() {
            public Object read(Json json, JsonValue jsonData, Class type) {
                return Skin.this.newDrawable(json.readValue("name", String.class, jsonData), json.readValue("color", Color.class, jsonData));
            }
        });
        return ((Json)v0);
    }
    ...
    public Sprite getSprite(String name) {  // has try-catch handlers
        ...
        if(v3 != null) {
            ...
            try {
                ...
                if((v5 instanceof AtlasRegion)) {
                    ...
                    v4_1 = new AtlasSprite(((AtlasRegion)v2));
                }
                else {
                    goto label_38;
                }
        ...
        label_19:
            if(v4_1 == null) {
                ...
                AtlasSprite v3_2 = v4_1;
            }

            try {
            label_21:
                this.add(name, v3_1, NinePatch.class);
                v4_2 = v3_1;
                goto label_4;
            }
            catch(GdxRuntimeException v1) {
    ...
    public TiledDrawable getTiledDrawable(String name) {
        Object v0;
        Object v1 = this.optional(name, TiledDrawable.class);
        if(v1 != null) {
            v0 = v1;
        }
        else {
            v0 = this.optional(name, Drawable.class);
            if(v0 == null) {
                TiledDrawable v1_1 = new TiledDrawable(this.getRegion(name));
                this.add(name, v1_1, TiledDrawable.class);
                TiledDrawable v0_1 = v1_1;
            }
            else if(!(v0 instanceof TiledDrawable)) {
                throw new GdxRuntimeException("Drawable found but is not a TiledDrawable: " + name + ", " + v0.getClass().getName());
            }
        }

        return ((TiledDrawable)v0);
    }
    ...
    public Drawable newDrawable(Drawable drawable) {
        TextureRegionDrawable v0;
        if((drawable instanceof TextureRegionDrawable)) {
            v0 = new TextureRegionDrawable(((TextureRegionDrawable)drawable));
        }
        else if((drawable instanceof NinePatchDrawable)) {
            NinePatchDrawable v0_1 = new NinePatchDrawable(((NinePatchDrawable)drawable));
        }
    ...
    public Drawable newDrawable(Drawable drawable, Color tint) {
        ...
        AtlasSprite v2;
        if((drawable instanceof TextureRegionDrawable)) {
            TextureRegion v1 = ((TextureRegionDrawable)drawable).getRegion();
            if((v1 instanceof AtlasRegion)) {
                v2 = new AtlasSprite(((AtlasRegion)v1));
            }
            else {
                v2_1 = new Sprite(v1);
            }
            ...
            NinePatchDrawable v0_1 = new NinePatchDrawable(((NinePatchDrawable)drawable));
            v0_1.setPatch(new NinePatch(v0_1.getPatch(), tint));
            goto label_8;
        label_18:
            ...
            SpriteDrawable v4 = new SpriteDrawable(((SpriteDrawable)drawable));
            v2_1 = v4.getSprite();
            if((v2_1 instanceof AtlasSprite)) {
                v2 = new AtlasSprite(((AtlasSprite)v2_1));
            }
            else {
                v2_1 = new Sprite(v2_1);
            }
