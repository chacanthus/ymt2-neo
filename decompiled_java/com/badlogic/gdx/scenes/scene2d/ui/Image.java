    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        if(this.drawable != null) {
            if(this.drawable.getClass() == TextureRegionDrawable.class) {
                TextureRegion v1 = this.drawable.getRegion();
                float v10 = this.getRotation();
                if(v8 == 1f && v9 == 1f && v10 == 0f) {
                    batch.draw(v1, v12 + this.imageX, v13 + this.imageY, this.imageWidth, this.imageHeight);
                    return;
                }

                batch.draw(v1, v12 + this.imageX, v13 + this.imageY, this.getOriginX() - this.imageX, this.getOriginY() - this.imageY, this.imageWidth, this.imageHeight, v8, v9, v10);
            }
            else {
