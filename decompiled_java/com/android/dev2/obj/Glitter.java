...
public class Glitter extends Ani {
    public Glitter(int _iPartCnt, float frameDuration, int _iLastFrameNumber) {
    ...
    public void draw(float _deltaTime) {
        if(this.visible) {
            ...
            GameScreen.batch.draw(Res.rgGlitter[this.getFrameNumber()], this.x, this.y, this.width, this.height);
        }
    }
}
