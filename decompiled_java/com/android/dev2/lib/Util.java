...
public class Util {
    ...
    private static float standard_screen_pixel_height;
    private static float standard_screen_pixel_width;

    static  {
        Util.standard_screen_pixel_width = 800f;
        Util.standard_screen_pixel_height = 480f;
    }
